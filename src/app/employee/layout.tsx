...
import { LayoutDashboard, CheckSquare, Clock, ChevronRight } from 'lucide-react'
import { cn } from '@/lib/utils'

const navItems = [
  { href: '/employee', icon: LayoutDashboard, label: 'My Dashboard' },
...
export default function EmployeeLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (!loading && profile && profile.role !== 'employee') router.replace('/admin')
